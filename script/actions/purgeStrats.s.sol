...
contract PurgeStrats is Script, HelperContract {
    // ===================
    //      STATES
    // ===================
    ...
    function run() external {
        ...
        StrategiesViewerFacet(address(diamond)).purgeStrategies();

        vm.stopBroadcast();
    }
}

// forge script ./script/purgeStrats.s.sol:PurgeStrats --chain-id 42161 --fork-url $ARBITRUM_RPC_URL --etherscan-api-key $ARBISCAN_API_KEY --verifier-url https://api.arbiscan.io/api --broadcast --verify -vvv --ffi
